...
def home():
    try:
        ...
        mince_price = soup_mince.find('div', class_ = 'base__PriceWrapper-sc-1mnb0pd-28 dDLLyP').text
    
    
    except requests.RequestException as e:
    # Handle request exceptions
        mince_info = f"Error fetching data: {e}"
    
    except Exception as e:
    # Handle all other exceptions
        mince_info= f"An error occurred: {e}"

    return render_template("index.html", mince_name=mince_name, mince_price = mince_price)
